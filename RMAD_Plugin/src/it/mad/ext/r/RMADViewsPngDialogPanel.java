 ...
 */
public class RMADViewsPngDialogPanel extends JLabel {

    /**
	 * Generated serial version ID.
	 */
	private static final long serialVersionUID = 1080775188997039307L;
    ...
    public static final SettingsModelIntegerBounded createHeightModel() {
        return new SettingsModelIntegerBounded("R-png-height",
                RMAD_cluster_optimalNodeModel.IMG_DEF_SIZE,
                RMAD_cluster_optimalNodeModel.IMG_MIN_HEIGHT,
                RMAD_cluster_optimalNodeModel.IMG_MAX_HEIGHT);
    }
    ...
    public static final SettingsModelIntegerBounded createWidthModel() {
        return new SettingsModelIntegerBounded("R-png-width",
        		RMAD_cluster_optimalNodeModel.IMG_DEF_SIZE,
        		RMAD_cluster_optimalNodeModel.IMG_MIN_WIDTH,
        		RMAD_cluster_optimalNodeModel.IMG_MAX_WIDTH);
    }
     ...
     * the png image.
     */
    public RMADViewsPngDialogPanel() {
        super();
